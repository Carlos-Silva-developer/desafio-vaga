import {MenuOpcao,MenuOpcaoGerencia} from "./MenuOpcao";
...
export function MenuGerencia() {
    return (
        <menu className="w-56 h-60 ps-6 pt-14 me-4 border-4 border-t-0 border-black">
            <ul className="py-2">
                <h1 className="text-2xl underline ">Products</h1>
                <div className="mt-5">
                    <MenuOpcaoGerencia texto="Company profile" />
                    <MenuOpcaoGerencia texto="Logout" />
